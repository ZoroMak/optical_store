...
function connect() {
    ...
    tokenJWT = localStorage.getItem('jwtToken');
...
function onConnected() {
    ...
    stompClient.send("/app/user.addUser",
        {},
        JSON.stringify({
            "username": username, // username - имя поля в Java
            "fullName": fullname, // fullName - имя поля в Java
            "status": 'ONLINE',
            "tokenJWT": tokenJWT,
            "authority": authority,
...
async function findAndDisplayConnectedUsers() {
    const connectedUsersResponse = await fetch('http://localhost:8088/users?username=' + username);
